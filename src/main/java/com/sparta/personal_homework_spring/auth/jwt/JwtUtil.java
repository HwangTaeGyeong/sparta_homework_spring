package com.sparta.personal_homework_spring.auth.jwt;
...
public class JwtUtil {
    ...
    private Key key; // JWT Secret Key 관리 방법 중 하나
    ...
    // Cookiedp 들어있던 JWT 토큰을 Substring
    // JWT 토큰 substring
    public String substringToken(String tokenValue) {
        ...
        throw
                new NullPointerException("Not Found Token");
    }
